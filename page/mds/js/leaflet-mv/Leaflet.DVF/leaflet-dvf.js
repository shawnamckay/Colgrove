...
*/
MVLeaflet.LinearFunction = MVLeaflet.Class.extend({
    ...
    setOptions: function(options) {
        MVLeaflet.Util.setOptions(this, options);
    ...
    getBounds: function() {
        ...
        return [ new MVLeaflet.Point(minX, minY), new MVLeaflet.Point(maxX, maxY) ];
    },
    ...
    samplePoints: function(count) {
        ...
        var points = [];
        while (x <= this._maxPoint.x) {
            points.push(new MVLeaflet.Point(x, this.evaluate(x)));
            x += segmentSize;
        }
        return points;
    },
    getIntersectionPoint: function(otherFunction) {
        ...
        if (this._slope !== otherFunction._slope) {
            ...
            point = new MVLeaflet.Point(x, y);
        }
        return point;
    }
});

MVLeaflet.ColorFunction = MVLeaflet.LinearFunction.extend({
    options: {
        alpha: 1,
        includeAlpha: false
    },
    initialize: function(minPoint, maxPoint, options) {
        ...
        var postProcess = function(y) {
            ...
            if (MVLeaflet.Browser.ie && colorString.indexOf("hsl") > -1) {
                colorString = MVLeaflet.hslColor(colorString).toRGBString();
            }
            return colorString;
        };
        MVLeaflet.LinearFunction.prototype.initialize.call(this, minPoint, maxPoint, {
...
MVLeaflet.HSLColorFunction = MVLeaflet.ColorFunction.extend({
    initialize: function(minPoint, maxPoint, options) {
        MVLeaflet.ColorFunction.prototype.initialize.call(this, minPoint, maxPoint, options);
...
MVLeaflet.RGBColorFunction = MVLeaflet.ColorFunction.extend({
    initialize: function(minPoint, maxPoint, options) {
        MVLeaflet.ColorFunction.prototype.initialize.call(this, minPoint, maxPoint, options);
...
MVLeaflet.RGBRedFunction = MVLeaflet.LinearFunction.extend({
    options: {
        outputGreen: 0,
        outputBlue: 0
    },
    initialize: function(minPoint, maxPoint, options) {
        MVLeaflet.RGBColorFunction.prototype.initialize.call(this, minPoint, maxPoint, options);
        this._dynamicPart = "outputRed";
    }
});

MVLeaflet.RGBBlueFunction = MVLeaflet.LinearFunction.extend({
    options: {
        outputRed: 0,
        outputGreen: 0
    },
...
MVLeaflet.RGBGreenFunction = MVLeaflet.LinearFunction.extend({
    options: {
        outputRed: 0,
        outputBlue: 0
    },
...
MVLeaflet.RGBColorBlendFunction = MVLeaflet.LinearFunction.extend({
    initialize: function(minX, maxX, rgbMinColor, rgbMaxColor) {
        rgbMinColor = new MVLeaflet.RGBColor(rgbMinColor);
        rgbMaxColor = new MVLeaflet.RGBColor(rgbMaxColor);
        ...
        this._minX = minX;
        this._maxX = maxX;
        this._redFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, red1), new MVLeaflet.Point(maxX, red2));
        this._greenFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, green1), new MVLeaflet.Point(maxX, green2));
        this._blueFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, blue1), new MVLeaflet.Point(maxX, blue2));
    },
    getBounds: function() {
        ...
        return [ new MVLeaflet.Point(redBounds[0].x, minY), new MVLeaflet.Point(redBounds[1].x, maxY) ];
    },
    evaluate: function(x) {
        return new MVLeaflet.RGBColor([ this._redFunction.evaluate(x), this._greenFunction.evaluate(x), this._blueFunction.evaluate(x) ]).toRGBString();
    }
});

MVLeaflet.HSLHueFunction = MVLeaflet.HSLColorFunction.extend({
    options: {
        outputSaturation: "100%",
        outputLuminosity: "50%"
    },
    initialize: function(minPoint, maxPoint, options) {
        MVLeaflet.HSLColorFunction.prototype.initialize.call(this, minPoint, maxPoint, options);
        this._dynamicPart = "outputHue";
    }
});

MVLeaflet.HSLSaturationFunction = MVLeaflet.LinearFunction.extend({
    options: {
        outputHue: 0,
        outputLuminosity: "50%"
    },
...
MVLeaflet.HSLLuminosityFunction = MVLeaflet.LinearFunction.extend({
    options: {
        outputHue: 0,
        outputSaturation: "100%"
    },
...
MVLeaflet.HSLColorBlendFunction = MVLeaflet.LinearFunction.extend({
    initialize: function(minX, maxX, hslMinColor, hslMaxColor) {
        hslMinColor = new MVLeaflet.HSLColor(hslMinColor);
        hslMaxColor = new MVLeaflet.HSLColor(hslMaxColor);
        ...
        this._minX = minX;
        this._maxX = maxX;
        this._hueFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, h1), new MVLeaflet.Point(maxX, h2));
        this._saturationFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, s1), new MVLeaflet.Point(maxX, s2));
        this._luminosityFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minX, l1), new MVLeaflet.Point(maxX, l2));
    },
    getBounds: function() {
        ...
        return [ new MVLeaflet.Point(hBounds[0].x, minY), new MVLeaflet.Point(hBounds[1].x, maxY) ];
    },
    evaluate: function(x) {
        return new MVLeaflet.HSLColor([ this._hueFunction.evaluate(x), this._saturationFunction.evaluate(x), this._luminosityFunction.evaluate(x) ]).toHSLString();
    }
});

MVLeaflet.PiecewiseFunction = MVLeaflet.LinearFunction.extend({
    initialize: function(functions, options) {
        ...
        MVLeaflet.LinearFunction.prototype.initialize.call(this, startPoint, endPoint, {
            preProcess: this.options.preProcess,
...
MVLeaflet.CustomColorFunction = MVLeaflet.PiecewiseFunction.extend({
    options: {
        interpolate: true
    },
    initialize: function(minX, maxX, colors, options) {
        ...
        for (var i = 0; i < colors.length; ++i) {
            ...
            colorFunction = this.options.interpolate ? new MVLeaflet.RGBColorBlendFunction(minX + xRange * i, minX + xRange * next, colors[i], colors[next]) : new MVLeaflet.RGBColorBlendFunction(minX + xRange * i, minX + xRange * next, colors[i], colors[i]);
            functions.push(colorFunction);
        }
        MVLeaflet.PiecewiseFunction.prototype.initialize.call(this, functions);
    }
});

MVLeaflet.CategoryFunction = MVLeaflet.Class.extend({
...
MVLeaflet.Util.getProperty = function(obj, property, defaultValue) {
    return property in obj ? obj[property] : defaultValue;
};

MVLeaflet.Util.setFieldValue = function(record, fieldName, value) {
...
MVLeaflet.Util.getFieldValue = function(record, fieldName) {
    var value = null;
    if (fieldName) {
...
MVLeaflet.Util.getNumericRange = function(records, fieldName) {
    var min = Number.MAX_VALUE;
    var max = Number.MIN_VALUE;
    for (var index in records) {
        if (records.hasOwnProperty(index)) {
            var record = records[index];
            var value = MVLeaflet.Util.getFieldValue(record, fieldName);
...
MVLeaflet.CategoryLegend = MVLeaflet.Class.extend({
    ...
    generate: function(options) {
        ...
        var legend = MVLeaflet.DomUtil.create("div", "legend", container);
        var className = options.className;
        var legendOptions = this.options;
        if (className) {
            MVLeaflet.DomUtil.addClass(legend, className);
        }
        if (options.title) {
            MVLeaflet.DomUtil.create("div", "legend-title", legend).innerHTML = options.title;
        }
        for (var key in legendOptions) {
            categoryOptions = legendOptions[key];
            var displayName = categoryOptions.displayName || key;
            var legendElement = MVLeaflet.DomUtil.create("div", "data-layer-legend", legend);
            var legendBox = MVLeaflet.DomUtil.create("div", "legend-box", legendElement);
            MVLeaflet.DomUtil.create("div", "key", legendElement).innerHTML = displayName;
            MVLeaflet.StyleConverter.applySVGStyle(legendBox, categoryOptions);
        }
        return container.innerHTML;
    }
});

MVLeaflet.LegendIcon = MVLeaflet.DivIcon.extend({
    initialize: function(fields, layerOptions, options) {
        var container = document.createElement("div");
        var legendContent = MVLeaflet.DomUtil.create("div", "legend", container);
        var legendTitle = MVLeaflet.DomUtil.create("div", "title", legendContent);
        var legendBox = MVLeaflet.DomUtil.create("div", "legend-box", legendContent);
        var legendValues = MVLeaflet.DomUtil.create("div", "legend-values", legendContent);
        var field;
        ...
        for (var key in fields) {
            field = fields[key];
            MVLeaflet.DomUtil.create("div", "key", legendValues).innerHTML = field.name || key;
            MVLeaflet.DomUtil.create("div", "value", legendValues).innerHTML = field.value;
        }
        MVLeaflet.StyleConverter.applySVGStyle(legendBox, layerOptions);
        legendBox.style.height = "5px";
        options.html = container.innerHTML;
        options.className = options.className || "legend-icon";
        MVLeaflet.DivIcon.prototype.initialize.call(this, options);
    }
});

MVLeaflet.legendIcon = function(fields, layerOptions, options) {
    return new MVLeaflet.LegendIcon(fields, layerOptions, options);
};

MVLeaflet.GeometryUtils = {
    ...
    getGeoJSONLocation: function(geoJSON, record, locationTextField, recordToLayer) {
        var geoJSONLayer = new MVLeaflet.GeoJSON(geoJSON, {
            pointToLayer: function(feature, latlng) {
                var location = {
                    location: latlng,
                    text: locationTextField ? MVLeaflet.Util.getFieldValue(record, locationTextField) : [ latlng.lat.toFixed(3), latlng.lng.toFixed(3) ].join(", "),
                    center: latlng
                };
        ...
        var center = null;
        try {
            center = MVLeaflet.GeometryUtils.loadCentroid(geoJSON);
        } catch (ex) {
            console.log("Error loading centroid for " + JSON.stringify(geoJSON));
        }
        return {
            location: geoJSONLayer,
            text: locationTextField ? MVLeaflet.Util.getFieldValue(record, locationTextField) : null,
            center: center
        };
    },
    mergeProperties: function(properties, featureCollection, mergeKey) {
        var features = featureCollection["features"];
        var featureIndex = MVLeaflet.GeometryUtils.indexFeatureCollection(features, mergeKey);
        var property;
        var mergeValue;
    ...
    loadCentroid: function(feature) {
        ...
        if (feature.geometry && feature.geometry.type === "Point") {
            centroidLatLng = new MVLeaflet.LatLng(feature.geometry.coordinates[1], feature.geometry.coordinates[0]);
            ...
            centroidLatLng = new MVLeaflet.LatLng(y, x);
        }
    ...
    loadCentroids: function(dictionary) {
        ...
        for (var key in dictionary) {
            ...
            centroids[key] = MVLeaflet.GeometryUtils.loadCentroid(feature);
        }
        return centroids;
    }
};

MVLeaflet.SVGPathBuilder = MVLeaflet.Class.extend({
...
MVLeaflet.StyleConverter = {
    ...
    applySVGStyle: function(element, svgStyle, additionalKeys) {
        var keyMap = MVLeaflet.StyleConverter.keyMap;
        if (additionalKeys) {
            keyMap = MVLeaflet.Util.extend(keyMap, additionalKeys);
        }
        element.style.borderStyle = "solid";
        for (var property in svgStyle) {
            MVLeaflet.StyleConverter.setCSSProperty(element, property, svgStyle[property], keyMap);
        }
        return element;
    },
    setCSSProperty: function(element, key, value, keyMap) {
        var keyMap = keyMap || MVLeaflet.StyleConverter.keyMap;
...
MVLeaflet.StylesBuilder = MVLeaflet.Class.extend({
...
MVLeaflet.PaletteBuilder = MVLeaflet.Class.extend({
    ...
    generate: function(options) {
        options = options || {};
        var container = document.createElement("div");
        var paletteElement = MVLeaflet.DomUtil.create("div", "palette", container);
        ...
        var styleBuilder = new MVLeaflet.StylesBuilder(categories, this._styleFunctionMap);
        var styles = styleBuilder.getStyles();
        if (options.className) {
            MVLeaflet.DomUtil.addClass(paletteElement, options.className);
        }
        for (var styleKey in styles) {
            var i = MVLeaflet.DomUtil.create("i", "palette-element", paletteElement);
            var style = styles[styleKey];
            MVLeaflet.StyleConverter.applySVGStyle(i, style);
        }
        return container.innerHTML;
    }
});
...
MVLeaflet.HTMLUtils = {
    buildTable: function(obj, className, ignoreFields) {
        ...
        var table = MVLeaflet.DomUtil.create("table", className);
        var thead = MVLeaflet.DomUtil.create("thead", "", table);
        var tbody = MVLeaflet.DomUtil.create("tbody", "", table);
        ...
        for (var property in obj) {
            if (obj.hasOwnProperty(property) && !inArray(ignoreFields, property)) {
                ...
                if (typeof value === "object") {
                    var container = document.createElement("div");
                    container.appendChild(MVLeaflet.HTMLUtils.buildTable(value, ignoreFields));
    ...
    animate: function(layer, from, to, options) {
        ...
        for (var key in from) {
            if (key != "color" && key != "fillColor" && to[key]) {
                linearFunctions[key] = new MVLeaflet.LinearFunction([ 0, from[key] ], [ frames - 1, to[key] ]);
            } else if (key == "color" || key == "fillColor") {
                linearFunctions[key] = new MVLeaflet.RGBColorBlendFunction(0, frames - 1, from[key], to[key]);
            }
        }
        var layerOptions = {};
        var frame = 0;
        var updateLayer = function() {
            ...
            layer.options = MVLeaflet.extend({}, layer.options, layerOptions);
...
MVLeaflet.Color = MVLeaflet.Class.extend({
...
MVLeaflet.RGBColor = MVLeaflet.Color.extend({
    initialize: function(colorDef) {
        MVLeaflet.Color.prototype.initialize.call(this, colorDef);
    },
    parseColorDef: function(colorDef) {
...
MVLeaflet.rgbColor = function(colorDef) {
    return new MVLeaflet.RGBColor(colorDef);
};

MVLeaflet.HSLColor = MVLeaflet.Color.extend({
    initialize: function(colorDef) {
        MVLeaflet.Color.prototype.initialize.call(this, colorDef);
    },
    parseColorDef: function(colorDef) {
...
MVLeaflet.hslColor = function(colorDef) {
    return new MVLeaflet.HSLColor(colorDef);
};

MVLeaflet.Animation = MVLeaflet.Class.extend({
...
MVLeaflet.Palettes = {
    huePalette: function(min, max, minH, maxH, options) {
        return new MVLeaflet.HSLHueFunction(new MVLeaflet.Point(min, minH), new MVLeaflet.Point(max, maxH), options);
    },
    luminosityPalette: function(min, max, minL, maxL, options) {
        return new MVLeaflet.HSLLuminosityFunction(new MVLeaflet.Point(min, minL), new MVLeaflet.Point(max, maxL), options);
    },
    saturationPalette: function(min, max, minS, maxS, options) {
        return new MVLeaflet.HSLSaturationFunction(new MVLeaflet.Point(min, minS), new MVLeaflet.Point(max, maxS), options);
    },
    rgbBlendPalette: function(min, max, minColor, maxColor, options) {
        return new MVLeaflet.RGBColorBlendFunction(min, max, minColor, maxColor, options);
    },
    hslBlendPalette: function(min, max, minColor, maxColor, options) {
        return new MVLeaflet.HSLColorBlendFunction(min, max, minColor, maxColor, options);
    },
    customColorPalette: function(min, max, colors, options) {
        return new MVLeaflet.CustomColorFunction(min, max, colors, options);
    }
};

MVLeaflet.DynamicColorPalettes = {
    rainbow: {
        text: "Rainbow",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 0, 300);
        }
    },
    greentored: {
        text: "Green - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 120, 0);
        }
    },
    yellowtored: {
        text: "Yellow - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 60, 0);
        }
    },
    orangetored: {
        text: "Orange - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 30, 0);
        }
    },
    redtopurple: {
        text: "Red - Purple",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 360, 270);
        }
    },
    bluetored: {
        text: "Blue - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 210, 360);
        }
    },
    bluetored2: {
        text: "Blue - Red 2",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.huePalette(min, max, 180, 0);
        }
    },
    whitetored: {
        text: "White - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.luminosityPalette(min, max, 1, .5, {
                outputHue: 0
            });
        }
    },
    ...
    graytored: {
        text: "Gray - Red",
        getPalette: function(min, max) {
            return MVLeaflet.Palettes.saturationPalette(min, max, 0, 1, {
                outputHue: 0
            });
        }
    },
...
MVLeaflet.DynamicPaletteElement = MVLeaflet.Class.extend({
    initialize: function(key, dynamicPalette) {
        this._key = key;
        this._dynamicPalette = dynamicPalette;
    },
    generate: function(options) {
        var paletteElement = MVLeaflet.DomUtil.create("div", "palette");
        ...
        if (this._dynamicPalette.text && showText) {
            MVLeaflet.DomUtil.create("div", "palette-text", paletteElement).innerHTML = '<i class="icon-ok hidden"></i>' + this._dynamicPalette.text;
        }
...
MVLeaflet.RegularPolygon = MVLeaflet.Polygon.extend({
    statics: {
        R: 6378.137,
        M_PER_KM: 1e3
    },
    initialize: function(centerLatLng, options) {
        ...
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.Polygon.prototype.initialize.call(this, this._getLatLngs(), options);
    },
    options: {
        fill: true,
        radius: 1e3,
    ...
    _getPoint: function(angle) {
        var toRad = function(number) {
            return number * MVLeaflet.LatLng.DEG_TO_RAD;
        };
        var toDeg = function(number) {
            return number * MVLeaflet.LatLng.RAD_TO_DEG;
        };
        var angleRadians = toRad(angle);
        var angularDistance = this.options.radius / MVLeaflet.RegularPolygon.M_PER_KM / MVLeaflet.RegularPolygon.R;
        ...
        lat2 = toDeg(lat2);
        lon2 = toDeg(lon2);
        return new MVLeaflet.LatLng(lat2, lon2);
    }
});

MVLeaflet.regularPolygon = function(centerLatLng, options) {
    return new MVLeaflet.RegularPolygon(centerLatLng, options);
};

MVLeaflet.Path.XLINK_NS = "http://www.w3.org/1999/xlink";

var TextFunctions = TextFunctions || {
    __updatePath: MVLeaflet.Path.prototype._updatePath,
    ...
    _createText: function(options) {
        ...
        if (options.path) {
            ...
            var pathID = MVLeaflet.Util.guid();
            ...
            textPath.setAttributeNS(MVLeaflet.Path.XLINK_NS, "xlink:href", "#" + pathID);
...
var PathFunctions = PathFunctions || {
    __updateStyle: MVLeaflet.Path.prototype._updateStyle,
    ...
    _createGradient: function(options) {
        ...
        var gradientGuid = MVLeaflet.Util.guid();
        this._gradientGuid = gradientGuid;
        options = options !== true ? MVLeaflet.extend({}, options) : {};
    ...
    _createDropShadow: function(options) {
        ...
        var filterGuid = MVLeaflet.Util.guid();
    ...
    _createImage: function(imageOptions) {
        ...
        image.setAttributeNS(MVLeaflet.Path.XLINK_NS, "xlink:href", imageOptions.url);
        return image;
    },
    ...
    _createFillPattern: function(imageOptions) {
        var patternGuid = MVLeaflet.Util.guid();
    ...
    _createShapeImage: function(imageOptions) {
        ...
        var imageSize = imageOptions.imageSize || new MVLeaflet.Point(diameter, diameter);
...
var LineTextFunctions = MVLeaflet.extend({}, TextFunctions);

LineTextFunctions.__updatePath = MVLeaflet.Polyline.prototype._updatePath;
...
LineTextFunctions.getCenter = function() {
    ...
    center = area ? new MVLeaflet.LatLng(lat / (6 * area), lng / (6 * area)) : latlngs[0];
    center.area = area;
    return center;
};
...
MVLeaflet.Polyline.include(LineTextFunctions);

MVLeaflet.CircleMarker.include(TextFunctions);

MVLeaflet.Path.include(PathFunctions);

MVLeaflet.Polygon.include(PathFunctions);

MVLeaflet.Polyline.include(PathFunctions);

MVLeaflet.CircleMarker.include(PathFunctions);

MVLeaflet.CircleMarker = MVLeaflet.CircleMarker.extend({
    _applyCustomStyles: function() {
...
MVLeaflet.Point.prototype.rotate = function(angle, point) {
    var radius = this.distanceTo(point);
    var theta = angle * MVLeaflet.LatLng.DEG_TO_RAD + Math.atan2(this.y - point.y, this.x - point.x);
    this.x = point.x + radius * Math.cos(theta);
    this.y = point.y + radius * Math.sin(theta);
};

MVLeaflet.MapMarker = MVLeaflet.Path.extend({
    ...
    getBounds: function() {
        var map = this._map, height = this.options.radius * 3, point = map.project(this._latlng), swPoint = new MVLeaflet.Point(point.x - this.options.radius, point.y), nePoint = new MVLeaflet.Point(point.x + this.options.radius, point.y - height), sw = map.unproject(swPoint), ne = map.unproject(nePoint);
    ...
    getPathString: function() {
        ...
        return new MVLeaflet.SVGPathBuilder(this._points, this._innerPoints).build(6);
    },
    getTextAnchor: function() {
        return new MVLeaflet.Point(this._point.x, this._point.y - 2 * this.options.radius);
    },
    _getPoints: function(inner) {
        ...
        if (!inner) {
            ...
            points.push(new MVLeaflet.Point(startPoint.x + multiplier * radius, startPoint.y - 1.5 * radius));
        }
        while (angle < degrees) {
    ...
    _getPoint: function(angle, radius, inner) {
        ...
        return new MVLeaflet.Point(this._point.x + this.options.position.x + radius * Math.cos(angle), this._point.y - 2 * markerRadius + this.options.position.y - radius * Math.sin(angle));
    },
    _applyCustomStyles: function() {
        if (this.options.shapeImage || this.options.imageCircleUrl) {
            this._createShapeImage(this.options.shapeImage);
...
MVLeaflet.mapMarker = function(centerLatLng, options) {
    return new MVLeaflet.MapMarker(centerLatLng, options);
};

MVLeaflet.RegularPolygonMarker = MVLeaflet.Path.extend({
    includes: TextFunctions,
    initialize: function(centerLatLng, options) {
        MVLeaflet.Path.prototype.initialize.call(this, options);
        this._latlng = centerLatLng;
    ...
    getBounds: function() {
        var map = this._map, radiusX = this.options.radius || this.options.radiusX, radiusY = this.options.radius || this.options.radiusY, deltaX = radiusX * Math.cos(Math.PI / 4), deltaY = radiusY * Math.sin(Math.PI / 4), point = map.project(this._latlng), swPoint = new MVLeaflet.Point(point.x - deltaX, point.y + deltaY), nePoint = new MVLeaflet.Point(point.x + deltaX, point.y - deltaY), sw = map.unproject(swPoint), ne = map.unproject(nePoint);
        return new MVLeaflet.LatLngBounds(sw, ne);
    },
    getLatLng: function() {
        return this._latlng;
    ...
    _getPoint: function(angle, radiusX, radiusY) {
        var startPoint = this.options.position ? this._point.add(new MVLeaflet.Point(this.options.position.x, this.options.position.y)) : this._point;
        var point = new MVLeaflet.Point(startPoint.x + radiusX * Math.cos(angle), startPoint.y + radiusY * Math.sin(angle));
...
MVLeaflet.regularPolygonMarker = function(centerLatLng, options) {
    return new MVLeaflet.RegularPolygonMarker(centerLatLng, options);
};

MVLeaflet.StarMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfPoints: 5,
        rotation: -15,
        maxDegrees: 360,
...
MVLeaflet.starMarker = function(centerLatLng, options) {
    return new MVLeaflet.StarMarker(centerLatLng, options);
};

MVLeaflet.TriangleMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 3,
        rotation: 30,
        radius: 5
...
MVLeaflet.triangleMarker = function(centerLatLng, options) {
    return new MVLeaflet.TriangleMarker(centerLatLng, options);
};

MVLeaflet.DiamondMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 4,
        radiusX: 5,
        radiusY: 10
...
MVLeaflet.diamondMarker = function(centerLatLng, options) {
    return new MVLeaflet.DiamondMarker(centerLatLng, options);
};

MVLeaflet.SquareMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 4,
        rotation: 45,
        radius: 5
...
MVLeaflet.squareMarker = function(centerLatLng, options) {
    return new MVLeaflet.SquareMarker(centerLatLng, options);
};

MVLeaflet.PentagonMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 5,
        rotation: -18,
        radius: 5
...
MVLeaflet.pentagonMarker = function(centerLatLng, options) {
    return new MVLeaflet.PentagonMarker(centerLatLng, options);
};

MVLeaflet.HexagonMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 6,
        rotation: 30,
        radius: 5
...
MVLeaflet.hexagonMarker = function(centerLatLng, options) {
    return new MVLeaflet.HexagonMarker(centerLatLng, options);
};

MVLeaflet.OctagonMarker = MVLeaflet.RegularPolygonMarker.extend({
    options: {
        numberOfSides: 8,
        rotation: 22.5,
        radius: 5
...
MVLeaflet.octagonMarker = function(centerLatLng, options) {
    return new MVLeaflet.OctagonMarker(centerLatLng, options);
};

MVLeaflet.SVGMarker = MVLeaflet.Path.extend({
    ...
    getPathString: function() {
        ...
        var addSVG = function() {
            ...
            var size = me.options.size || new MVLeaflet.Point(width, height);
            var scaleSize = new MVLeaflet.Point(size.x / width, size.y / height);
            ...
            g.appendChild(svg);
            var transforms = [];
            var anchor = me.options.anchor || new MVLeaflet.Point(-size.x / 2, -size.y / 2);
...
MVLeaflet.MarkerGroup = MVLeaflet.FeatureGroup.extend({
    initialize: function(latlng, markers) {
        MVLeaflet.FeatureGroup.prototype.initialize.call(this, markers);
...
MVLeaflet.BarMarker = MVLeaflet.Path.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Path.prototype.initialize.call(this, options);
        this._latlng = centerLatLng;
    },
    ...
    getBounds: function() {
        var map = this._map, point = map.project(this._latlng), halfWidth = this.options.width / 2, swPoint = new MVLeaflet.Point(point.x - halfWidth, point.y), nePoint = new MVLeaflet.Point(point.x + halfWidth, point.y - this.options.maxHeight), sw = map.unproject(swPoint), ne = map.unproject(nePoint);
        return new MVLeaflet.LatLngBounds(sw, ne);
    },
    getLatLng: function() {
        return this._latlng;
    ...
    getPathString: function() {
        ...
        return new MVLeaflet.SVGPathBuilder(this._points).build();
    },
    _getPoints: function() {
        var points = [];
        ...
        sePoint = new MVLeaflet.Point(startX + halfWidth, startY);
        nePoint = new MVLeaflet.Point(startX + halfWidth, startY - height);
        nwPoint = new MVLeaflet.Point(startX - halfWidth, startY - height);
        swPoint = new MVLeaflet.Point(startX - halfWidth, startY);
        points = [ sePoint, nePoint, nwPoint, swPoint ];
        return points;
    }
});

MVLeaflet.barMarker = function(centerLatLng, options) {
    return new MVLeaflet.BarMarker(centerLatLng, options);
};

MVLeaflet.ChartMarker = MVLeaflet.FeatureGroup.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        this._layers = {};
        this._latlng = centerLatLng;
    ...
    _bindMouseEvents: function(chartElement) {
        ...
        chartElement.on("mouseover", function(e) {
            ...
            newPoint = new MVLeaflet.Point(newX, newY);
            var legendOptions = {};
            ...
            var icon = new MVLeaflet.LegendIcon(legendOptions, currentOptions, {
                className: "leaflet-div-icon",
                iconSize: tooltipOptions ? tooltipOptions.iconSize : iconSize,
                iconAnchor: newPoint
            });
            currentOptions.marker = new MVLeaflet.Marker(self._latlng, {
                icon: icon
            });
...
MVLeaflet.BarChartMarker = MVLeaflet.ChartMarker.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.ChartMarker.prototype.initialize.call(this, centerLatLng, options);
    },
    options: {
        weight: 1,
        opacity: 1,
        ...
        width: 10,
        offset: 0,
        iconSize: new MVLeaflet.Point(50, 40)
    },
    _loadComponents: function() {
        ...
        for (var key in data) {
            ...
            bar = new MVLeaflet.BarMarker(this._latlng, options);
...
MVLeaflet.RadialBarMarker = MVLeaflet.Path.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Path.prototype.initialize.call(this, options);
        this._latlng = centerLatLng;
    },
    ...
    _getPoint: function(angle, radiusX, radiusY) {
        return new MVLeaflet.Point(this._point.x + this.options.position.x + radiusX * Math.cos(angle), this._point.y + this.options.position.y + radiusY * Math.sin(angle));
    }
});

MVLeaflet.radialBarMarker = function(centerLatLng, options) {
    return new MVLeaflet.RadialBarMarker(centerLatLng, options);
};

MVLeaflet.PieChartMarker = MVLeaflet.ChartMarker.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.ChartMarker.prototype.initialize.call(this, centerLatLng, options);
    },
    ...
    _loadComponents: function() {
        ...
        if (sum > 0) {
            for (key in data) {
                ...
                options.displayName = chartOption.displayName;
                options.displayText = chartOption.displayText;
                bar = new MVLeaflet.RadialBarMarker(this._latlng, options);
                this._bindMouseEvents(bar);
...
MVLeaflet.pieChartMarker = function(centerLatLng, options) {
    return new MVLeaflet.PieChartMarker(centerLatLng, options);
};

MVLeaflet.CoxcombChartMarker = MVLeaflet.PieChartMarker.extend({
    statics: {
...
MVLeaflet.CoxcombChartMarker = MVLeaflet.CoxcombChartMarker.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.PieChartMarker.prototype.initialize.call(this, centerLatLng, options);
    },
    options: {
        weight: 1,
        opacity: 1,
        ...
        maxDegrees: 360,
        iconSize: new MVLeaflet.Point(50, 40),
        sizeMode: MVLeaflet.CoxcombChartMarker.SIZE_MODE_AREA
    },
    _loadComponents: function() {
        var value, minValue, maxValue;
        var angle = 0;
        ...
        for (var key in data) {
            ...
            if (this.options.sizeMode === MVLeaflet.CoxcombChartMarker.SIZE_MODE_RADIUS) {
                var evalFunctionX = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minValue, 0), new MVLeaflet.Point(maxValue, radiusX));
                var evalFunctionY = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minValue, 0), new MVLeaflet.Point(maxValue, radiusY));
                ...
                var evalFunctionArea = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minValue, 0), new MVLeaflet.Point(maxValue, maxArea), {
...
MVLeaflet.coxcombChartMarker = function(centerLatLng, options) {
    return new MVLeaflet.CoxcombChartMarker(centerLatLng, options);
};

MVLeaflet.RadialBarChartMarker = MVLeaflet.ChartMarker.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.ChartMarker.prototype.initialize.call(this, centerLatLng, options);
    },
    ...
    _loadComponents: function() {
        ...
        for (var key in data) {
            ...
            minValue = chartOption.minValue || 0;
            maxValue = chartOption.maxValue || 100;
            var angleFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minValue, 0), new MVLeaflet.Point(maxValue, maxDegrees));
...
MVLeaflet.radialBarChartMarker = function(centerLatLng, options) {
    return new MVLeaflet.RadialBarChartMarker(centerLatLng, options);
};

MVLeaflet.StackedRegularPolygonMarker = MVLeaflet.ChartMarker.extend({
    options: {
        iconSize: new MVLeaflet.Point(50, 40)
    },
    initialize: function(centerLatLng, options) {
    ...
    _loadComponents: function() {
        ...
        for (key in data) {
            ...
            options.minValue = minValue;
            options.maxValue = maxValue;
            var evalFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(minValue, minRadius), new MVLeaflet.Point(maxValue, maxRadius));
            ...
            options.color = chartOption.color || this.options.color;
            options.displayText = chartOption.displayText;
            bar = new MVLeaflet.RegularPolygonMarker(this._latlng, options);
            this._bindMouseEvents(bar);
...
MVLeaflet.RadialMeterMarker = MVLeaflet.ChartMarker.extend({
    initialize: function(centerLatLng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.ChartMarker.prototype.initialize.call(this, centerLatLng, options);
    },
    ...
    _loadComponents: function() {
        ...
        for (var key in data) {
            ...
            var evalFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(startAngle, minValue), new MVLeaflet.Point(maxAngle, maxValue));
...
MVLeaflet.LocationModes = {
    LATLNG: function(record, index) {
        var getLocation = function(latitudeField, longitudeField) {
            var latitude = MVLeaflet.Util.getFieldValue(record, latitudeField);
            var longitude = MVLeaflet.Util.getFieldValue(record, longitudeField);
            var location = null;
            if (latitude && longitude) {
                var latlng = new MVLeaflet.LatLng(latitude, longitude);
                location = {
                    location: latlng,
    ...
    GEOHASH: function(record, index) {
        var geohash = this.options.geohashField ? MVLeaflet.Util.getFieldValue(record, this.options.geohashField) : index;
        var locationInfo = decodeGeoHash(geohash);
        var bounds;
        if (locationInfo.latitude[2] && locationInfo.longitude[2]) {
            bounds = new MVLeaflet.LatLngBounds(new MVLeaflet.LatLng(locationInfo.latitude[0], locationInfo.longitude[0]), new MVLeaflet.LatLng(locationInfo.latitude[1], locationInfo.longitude[1]));
        }
        return {
            location: bounds,
            text: geohash,
    ...
    GWCOUNTRY: function(record, index) {
        var code = this.options.codeField ? MVLeaflet.Util.getFieldValue(record, this.options.codeField) : index;
        var geoJSON;
        var centroid;
        var gwNoLookup = MVLeaflet.gwNoLookup || {};
        var countries = MVLeaflet.countries || {};
        var countryCentroids = MVLeaflet.countryCentroids || {};
        ...
        return {
            location: geoJSONLayer,
            text: MVLeaflet.GeometryUtils.getName(geoJSON) || code,
            center: centroid
        };
    },
    COUNTRY: function(record, index) {
        ...
        var geoJSON;
        var centroid;
        var codeLookup = MVLeaflet.codeLookup || {};
        var alpha2Lookup = MVLeaflet.alpha2Lookup || {};
        var fips2Lookup = MVLeaflet.fips2Lookup || {};
        var countries = MVLeaflet.countries || {};
        var countryCentroids = MVLeaflet.countryCentroids || {};
        var originalCode = code.toUpperCase();
        code = originalCode;
    ...
    STATE: function(record, index) {
        ...
        var geoJSON;
        var centroid;
        var states = MVLeaflet.states || {};
        var stateCentroids = MVLeaflet.stateCentroids || {};
        var originalCode = code.toUpperCase();
        code = originalCode;
        geoJSON = states[code];
    ...
    GEOJSON: function(record, index) {
        ...
        var geoJSON = locationField ? MVLeaflet.Util.getFieldValue(record, locationField) : record;
        var location = null;
        if (geoJSON) {
            var me = this;
            ...
            location = MVLeaflet.GeometryUtils.getGeoJSONLocation(geoJSON, record, this.options.locationTextField, recordToLayer);
        }
        return location;
    },
    LOOKUP: function(record, index) {
        var code = this.options.codeField ? MVLeaflet.Util.getFieldValue(record, this.options.codeField) : index;
        this._lookupIndex = this._lookupIndex || MVLeaflet.GeometryUtils.indexFeatureCollection(this.options.locationLookup, this.options.locationIndexField || this.options.codeField);
    ...
    CUSTOM: function(record, index) {
        ...
        var fieldValue = MVLeaflet.Util.getFieldValue(record, locationField);
        var context = {};
        var location;
...
MVLeaflet.DataLayer = MVLeaflet.LayerGroup.extend({
    includes: MVLeaflet.Mixin.Events,
    initialize: function(data, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.LayerGroup.prototype.initialize.call(this, options);
        data = data || {};
        ...
        this._boundaryLayer = new MVLeaflet.LayerGroup();
    ...
    onAdd: function(map) {
        MVLeaflet.LayerGroup.prototype.onAdd.call(this, map);
        map.on("zoomend", this._zoomFunction, this);
    },
    onRemove: function(map) {
        MVLeaflet.LayerGroup.prototype.onRemove.call(this, map);
    ...
    options: {
        ...
        locationMode: MVLeaflet.LocationModes.LATLNG,
        ...
        tooltipOptions: {
            iconSize: new MVLeaflet.Point(60, 50),
            iconAnchor: new MVLeaflet.Point(-5, 50),
    ...
    _addBoundary: function(location, options, record) {
        ...
        if (this.options.includeBoundary) {
            if (layer instanceof MVLeaflet.LatLngBounds) {
                layer = new MVLeaflet.Rectangle(layer);
            }
            if (layer.setStyle) {
                var style;
                ...
                style = style || this.options.boundaryStyle || MVLeaflet.extend({}, options, {
                    fillOpacity: .2,
                    clickable: false
                });
    ...
    _getMarker: function(location, options, record) {
        ...
        if (location) {
            if (options.numberOfSides >= 30 && !(options.innerRadius || options.innerRadiusX && options.innerRadiusY)) {
                marker = new MVLeaflet.CircleMarker(location, options);
            } else {
                marker = new MVLeaflet.RegularPolygonMarker(location, options);
            }
        }
        return marker;
    },
    ...
    setDisplayOption: function(key, options) {
        ...
        if (key in this.options.displayOptions) {
            ...
            this.options.displayOptions[key] = MVLeaflet.extend({}, existingOption, options);
        } else {
    ...
    addData: function(data) {
        var records = this.options.recordsField !== null && this.options.recordsField.length > 0 ? MVLeaflet.Util.getFieldValue(data, this.options.recordsField) : data;
        if (this.options.locationMode === MVLeaflet.LocationModes.CUSTOM && this.options.preload) {
    ...
    _bindMouseEvents: function(layer, layerOptions, legendDetails) {
        ...
        var highlight = function(e) {
            ...
            var icon = new MVLeaflet.LegendIcon(legendDetails, layerOptions, {
            ...
            var tooltip = new MVLeaflet.Marker(latlng, {
                icon: icon
            });
    ...
    _getDynamicOptions: function(record) {
        var layerOptions = MVLeaflet.Util.extend({}, this.options.layerOptions);
        ...
        if (displayOptions) {
            for (var property in displayOptions) {
                ...
                var fieldValue = MVLeaflet.Util.getFieldValue(record, property);
                var valueFunction;
                ...
                if (propertyOptions.styles) {
                    layerOptions = MVLeaflet.Util.extend(layerOptions, propertyOptions.styles[fieldValue]);
    ...
    _getLegendElement: function(params) {
        ...
        MVLeaflet.StyleConverter.applySVGStyle(i, layerOptions);
        for (var property in displayProperties) {
            if (ignoreProperties.indexOf(property) === -1) {
                ...
                if (valueFunction && (valueFunction.getBounds || displayProperties.minValue && displayProperties.maxValue)) {
                    ...
                    var binFunction = new MVLeaflet.LinearFunction(new MVLeaflet.Point(0, minX), new MVLeaflet.Point(numSegments, maxX));
                    displayMin = minX;
                    displayMax = maxX;
                    ...
                    MVLeaflet.StyleConverter.setCSSProperty(i, property, value);
    ...
    _getLegend: function(legendOptions) {
        ...
        var container = document.createElement("div");
        var legendElement = MVLeaflet.DomUtil.create("div", "legend", container);
        ...
        var displayOptions = this.options.displayOptions || {};
        if (className) {
            MVLeaflet.DomUtil.addClass(legendElement, className);
        }
        if (legendOptions.title) {
            MVLeaflet.DomUtil.create("legend", "", legendElement).innerHTML = legendOptions.title;
        }
        ...
        for (var field in displayOptions) {
            ...
            MVLeaflet.DomUtil.create("div", "legend-title", legendElement).innerHTML = displayName;
            if (styles) {
                legendElement.innerHTML += new MVLeaflet.CategoryLegend(styles).generate();
            } else {
                var legendItems = MVLeaflet.DomUtil.create("div", "data-layer-legend");
                var minValue = MVLeaflet.DomUtil.create("div", "min-value", legendItems);
                var scaleBars = MVLeaflet.DomUtil.create("div", "scale-bars", legendItems);
                var maxValue = MVLeaflet.DomUtil.create("div", "max-value", legendItems);
...
MVLeaflet.dataLayer = function(data, options) {
    return new MVLeaflet.DataLayer(data, options);
};

MVLeaflet.MapMarkerDataLayer = MVLeaflet.DataLayer.extend({
    _getMarker: function(latLng, layerOptions, record) {
        return new MVLeaflet.MapMarker(latLng, layerOptions);
    }
});

MVLeaflet.mapMarkerDataLayer = function(data, options) {
    return new MVLeaflet.MapMarkerDataLayer(data, options);
};

MVLeaflet.MarkerDataLayer = MVLeaflet.DataLayer.extend({
    initialize: function(data, options) {
        this._markerMap = {};
        MVLeaflet.DataLayer.prototype.initialize.call(this, data, options);
    },
    options: {
        recordsField: "features",
        locationMode: MVLeaflet.LocationModes.LATLNG,
    ...
    _getMarker: function(latLng, layerOptions, record) {
        ...
        return new MVLeaflet.Marker(latLng, layerOptions);
    },
    _getLegendElement: function(params) {},
...
MVLeaflet.markerDataLayer = function(data, options) {
    return new MVLeaflet.MarkerDataLayer(data, options);
};

MVLeaflet.PanoramioLayer = MVLeaflet.MarkerDataLayer.extend({
    statics: {
...
MVLeaflet.PanoramioLayer = MVLeaflet.PanoramioLayer.extend({
    initialize: function(options) {
        MVLeaflet.MarkerDataLayer.prototype.initialize.call(this, {}, options);
        this._from = 0;
        this._to = MVLeaflet.PanoramioLayer.NUM_PHOTOS;
        this._calls = [];
    },
    options: {
        recordsField: "photos",
        ...
        locationMode: MVLeaflet.LocationModes.LATLNG,
        showLegendTooltips: false,
        sizeBy: MVLeaflet.PanoramioLayer.SIZE_BY_DATE,
        layerOptions: {
            opacity: 1
        },
        onEachRecord: function(layer, record) {
            ...
            layer.on("click", function(e) {
                var container = document.createElement("div");
                var content = MVLeaflet.DomUtil.create("div", "", container);
                var photo = MVLeaflet.DomUtil.create("img", "photo", content);
                photo.setAttribute("onload", "this.style.opacity=1;");
                photo.setAttribute("src", photoUrl);
                photo.style.width = width + "px";
                var photoInfo = MVLeaflet.DomUtil.create("div", "photo-info", content);
                ...
                var authorLink = MVLeaflet.DomUtil.create("a", "author-link", content);
                authorLink.setAttribute("target", "_blank");
                authorLink.setAttribute("href", record["owner_url"]);
                authorLink.innerHTML = "by " + record["owner_name"];
                var icon = new MVLeaflet.DivIcon({
                    className: "photo-details",
                    html: container.innerHTML,
                    iconAnchor: [ width / 2, height / 2 ]
                });
                var marker = new MVLeaflet.Marker(e.target._latlng, {
                    icon: icon,
                    zIndexOffset: offset
                });
        ...
        setIcon: function(record, options) {
            var title = MVLeaflet.Util.getFieldValue(record, "photo_title");
            var size = null;
            if (this._sizeFunction) {
                size = this._sizeFunction.evaluate(record.index);
            }
            var iconSize = size ? new MVLeaflet.Point(size, size) : MVLeaflet.PanoramioLayer.SIZES[this.options.size];
    ...
    includes: MVLeaflet.Mixin.Events,
    onAdd: function(map) {
        MVLeaflet.DataLayer.prototype.onAdd.call(this, map);
        ...
        var resetFunction = function(e) {
            me._from = 0;
            me._to = MVLeaflet.PanoramioLayer.NUM_PHOTOS;
    ...
    onRemove: function(map) {
        MVLeaflet.DataLayer.prototype.onRemove.call(this, map);
        if (map.attributionControl) {
    ...
    calculateSizeByDate: function(data) {
        ...
        for (var i = 0; i < photos.length; ++i) {
            var photo = photos[i];
            var timestamp = moment(photo["upload_date"], MVLeaflet.PanoramioLayer.UPLOAD_DATE_FORMAT);
        ...
        var size = MVLeaflet.PanoramioLayer.SIZES[this.options.size][0];
        this._sizeFunction = new MVLeaflet.LinearFunction([ timestamps[0], size / 2 ], [ timestamps[timestamps.length - 1], size ]);
        return data;
    },
    calculateSizeByPopularity: function(data) {
        ...
        var size = MVLeaflet.PanoramioLayer.SIZES[this.options.size][0];
        this._sizeFunction = new MVLeaflet.LinearFunction([ 0, size / 2 ], [ photos.length, size ]);
        return data;
    },
    next: function() {
        this._from = this._to;
        this._to = this._from + MVLeaflet.PanoramioLayer.NUM_PHOTOS;
        this.requestPhotos();
    },
    previous: function() {
        this._to = this._from;
        this._from = this._from - MVLeaflet.PanoramioLayer.NUM_PHOTOS;
        this.requestPhotos();
    },
    ...
    requestPhotos: function() {
        ...
        var request = this.requestJsonp("http://www.panoramio.com/map/get_panoramas.php", {
            ...
            if (moment && me.options.sizeBy === MVLeaflet.PanoramioLayer.SIZE_BY_DATE) {
                data = me.calculateSizeByDate(data);
            } else if (me.options.sizeBy === MVLeaflet.PanoramioLayer.SIZE_BY_POPULARITY) {
...
MVLeaflet.panoramioLayer = function(options) {
    return new MVLeaflet.PanoramioLayer(options);
};

MVLeaflet.GeohashDataLayer = MVLeaflet.DataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.DataLayer.prototype.initialize.call(this, data, options);
    },
    options: {
        recordsField: "features",
        locationMode: MVLeaflet.LocationModes.GEOHASH,
    ...
    _getLayer: function(geohash, layerOptions, record) {
        return new MVLeaflet.Rectangle(geohash.location, layerOptions);
    }
});

MVLeaflet.geohashDataLayer = function(data, options) {
    return new MVLeaflet.GeohashDataLayer(data, options);
};

MVLeaflet.ChoroplethDataLayer = MVLeaflet.DataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.DataLayer.prototype.initialize.call(this, data, options);
    },
    options: {
        recordsField: "features",
        locationMode: MVLeaflet.LocationModes.COUNTRY,
        codeField: "ISO",
        displayField: null,
        displayOptions: null,
        layerOptions: {
    ...
    _getLayer: function(location, layerOptions, record) {
        if (location.location instanceof MVLeaflet.LatLng) {
            location.location = this._markerFunction.call(this, location.location, layerOptions, record);
        }
        if (location.location.setStyle) {
            layerOptions.gradient = location.location instanceof MVLeaflet.Polyline ? false : layerOptions.gradient;
...
MVLeaflet.choroplethDataLayer = function(data, options) {
    return new MVLeaflet.ChoroplethDataLayer(data, options);
};

MVLeaflet.ChartDataLayer = MVLeaflet.DataLayer.extend({
    options: {
        showLegendTooltips: false
    },
    initialize: function(data, options) {
    ...
    _getLayer: function(latLng, layerOptions, record) {
        ...
        for (var key in this.options.chartOptions) {
            options.data[key] = MVLeaflet.Util.getFieldValue(record, key);
        }
    ...
    _getLegend: function(legendOptions) {
        var dataLayerLegend = MVLeaflet.DataLayer.prototype._getLegend.call(this, legendOptions);
        var legend = new MVLeaflet.CategoryLegend(this.options.chartOptions);
        legendOptions = legendOptions || this.options.legendOptions;
        return legend.generate(legendOptions);
    }
});

MVLeaflet.BarChartDataLayer = MVLeaflet.ChartDataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.ChartDataLayer.prototype.initialize.call(this, data, options);
    },
    _getMarker: function(latLng, options) {
        return new MVLeaflet.BarChartMarker(latLng, options);
    }
});

MVLeaflet.barChartDataLayer = function(data, options) {
    return new MVLeaflet.BarChartDataLayer(data, options);
};

MVLeaflet.RadialBarChartDataLayer = MVLeaflet.ChartDataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.ChartDataLayer.prototype.initialize.call(this, data, options);
    },
    _getMarker: function(latLng, options) {
        return new MVLeaflet.RadialBarChartMarker(latLng, options);
    }
});

MVLeaflet.radialBarChartDataLayer = function(data, options) {
    return new MVLeaflet.RadialBarChartDataLayer(data, options);
};

MVLeaflet.PieChartDataLayer = MVLeaflet.ChartDataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.ChartDataLayer.prototype.initialize.call(this, data, options);
    },
    _getMarker: function(latLng, options) {
        return new MVLeaflet.PieChartMarker(latLng, options);
    }
});

MVLeaflet.pieChartDataLayer = function(data, options) {
    return new MVLeaflet.PieChartDataLayer(data, options);
};

MVLeaflet.CoxcombChartDataLayer = MVLeaflet.ChartDataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.ChartDataLayer.prototype.initialize.call(this, data, options);
    },
    _getMarker: function(latLng, options) {
        return new MVLeaflet.CoxcombChartMarker(latLng, options);
    }
});

MVLeaflet.coxcombChartDataLayer = function(data, options) {
    return new MVLeaflet.CoxcombChartDataLayer(data, options);
};

MVLeaflet.StackedRegularPolygonDataLayer = MVLeaflet.ChartDataLayer.extend({
    initialize: function(data, options) {
        MVLeaflet.ChartDataLayer.prototype.initialize.call(this, data, options);
    },
    _getMarker: function(latLng, options) {
        return new MVLeaflet.StackedRegularPolygonMarker(latLng, options);
    }
});

MVLeaflet.stackedRegularPolygonDataLayer = function(data, options) {
    return new MVLeaflet.StackedRegularPolygonDataLayer(data, options);
};

MVLeaflet.RadialMeterMarkerDataLayer = MVLeaflet.DataLayer.extend({
    options: {
        showLegendTooltips: false
    },
    initialize: function(data, options) {
    ...
    _getMarker: function(latLng, options) {
        return new MVLeaflet.RadialMeterMarker(latLng, options);
    }
});

MVLeaflet.radialMeterMarkerDataLayer = function(data, options) {
    return new MVLeaflet.RadialMeterMarkerDataLayer(data, options);
};

MVLeaflet.CalloutLine = MVLeaflet.Path.extend({
    statics: {
        LINESTYLE: {
            ARC: "arc",
            ANGLE: "angle",
...
MVLeaflet.CalloutLine = MVLeaflet.CalloutLine.extend({
    initialize: function(latlng, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.Path.prototype.initialize.call(this, options);
        this._latlng = latlng;
    ...
    options: {
        size: new MVLeaflet.Point(60, 30),
        position: new MVLeaflet.Point(0, 0),
        color: "#FFFFFF",
        opacity: 1,
        weight: 2,
        fillColor: "#000000",
        ...
        gradient: false,
        dropShadow: false,
        direction: MVLeaflet.CalloutLine.DIRECTION.NE,
        lineStyle: MVLeaflet.CalloutLine.LINESTYLE.ANGLE,
        lineCap: "butt",
        lineJoin: "miter",
        arrow: false
    },
    ...
    _getPathAngle: function() {
        return new MVLeaflet.SVGPathBuilder(this._points, [], {
            closePath: false
        }).build(6);
    },
    _getPathArc: function() {
        var direction = (this.options.direction || MVLeaflet.CalloutLine.DIRECTION.NE).toLowerCase();
    ...
    _getPoints: function() {
        ...
        var yMultiplier = yDirection === "n" ? -1 : 1;
        points.push(new MVLeaflet.Point(x, y));
        var yEnd = y + yMultiplier * height;
        var halfWidth = width / 2;
        var angle = Math.atan(height / halfWidth);
        if (this.options.lineStyle === MVLeaflet.CalloutLine.LINESTYLE.ARC) {
            angle = Math.atan(Math.pow(height, 2) / halfWidth);
        } else if (this.options.lineStyle === MVLeaflet.CalloutLine.LINESTYLE.STRAIGHT) {
            angle = Math.atan(height / width);
        }
        this._angle = angle;
        if (this.options.lineStyle !== MVLeaflet.CalloutLine.LINESTYLE.STRAIGHT) {
            var elbowPoint = new MVLeaflet.Point(x + xMultiplier * halfWidth, yEnd);
            points.push(elbowPoint);
        }
        var endPoint = new MVLeaflet.Point(x + xMultiplier * width, yEnd);
        points.push(endPoint);
        return points;
    },
    getBounds: function() {
        var map = this._map, point = map.project(this._latlng), swPoint = new MVLeaflet.Point(point.x + this.options.position.x, point.y + this.options.position.y), nePoint = new MVLeaflet.Point(swPoint.x + this.options.size.x, swPoint.y - this.options.size.y), sw = map.unproject(swPoint), ne = map.unproject(nePoint);
        return new MVLeaflet.LatLngBounds(sw, ne);
    },
    setLatLng: function(latlng) {
        this._latlng = latlng;
    ...
    getPathString: function() {
        this._path.setAttribute("shape-rendering", "geometricPrecision");
        var lineStyle = this.options.lineStyle || MVLeaflet.CalloutLine.LINESTYLE.ANGLE;
        var path = "";
        if (lineStyle === MVLeaflet.CalloutLine.LINESTYLE.ANGLE || lineStyle === MVLeaflet.CalloutLine.LINESTYLE.STRAIGHT) {
...
MVLeaflet.calloutLine = function(latlng, options) {
    return new MVLeaflet.CalloutLine(latlng, options);
};

MVLeaflet.Callout = MVLeaflet.LayerGroup.extend({
    options: {
        color: "#FFFFFF",
        fillColor: "#FFFFFF"
    },
    ...
    addArrow: function(angle, direction, position) {
        if (this.options.arrow) {
            var angle = MVLeaflet.LatLng.RAD_TO_DEG * angle;
            ...
            var arrow = new MVLeaflet.RegularPolygonMarker(this._latlng, {
                position: position,
    ...
    addLine: function() {
        ...
        var calloutLine = new MVLeaflet.CalloutLine(this._latlng, lineOptions);
    ...
    addIcon: function(direction, position) {
        ...
        icon.options.iconAnchor = new MVLeaflet.Point(xAnchor, yAnchor);
        var iconMarker = new MVLeaflet.Marker(this._latlng, {
            icon: icon
        });
    ...
    addLayers: function() {
        ...
        var position = this.options.position || new MVLeaflet.Point(0, 0);
        var calloutLine;
...
MVLeaflet.callout = function(latlng, options) {
    return new MVLeaflet.Callout(latlng, options);
};

MVLeaflet.FlowLine = MVLeaflet.DataLayer.extend({
    statics: {
        LINE_FUNCTION: function(latlng1, latlng2, options) {
            return new MVLeaflet.Polyline([ latlng1, latlng2 ], options);
        },
        LINE_FUNCTION_INTERPOLATED: function(latlng1, latlng2, options) {
            ...
            var lineFunction = new MVLeaflet.LinearFunction(point1, point2);
...
MVLeaflet.FlowLine = MVLeaflet.FlowLine.extend({
    initialize: function(data, options) {
        MVLeaflet.Util.setOptions(this, options);
        MVLeaflet.DataLayer.prototype.initialize.call(this, data, options);
    },
    options: {
        getLine: MVLeaflet.FlowLine.LINE_FUNCTION
    },
    onEachSegment: function(record1, record2, line) {
        var deltas = {};
        if (this.options.timeField) {
            var timeValue1 = MVLeaflet.Util.getFieldValue(record1, this.options.timeField);
            var timeValue2 = MVLeaflet.Util.getFieldValue(record2, this.options.timeField);
        ...
        for (var key in this.options.displayOptions) {
            var value1 = MVLeaflet.Util.getFieldValue(record1, key);
            var value2 = MVLeaflet.Util.getFieldValue(record2, key);
...
MVLeaflet.flowLine = function(data, options) {
    return new MVLeaflet.FlowLine(data, options);
};

MVLeaflet.ArcedFlowLine = MVLeaflet.FlowLine.extend({
    options: {
        getLine: function(latlng1, latlng2, options) {
            return new MVLeaflet.ArcedPolyline([ latlng1, latlng2 ], options);
        }
    },
    initialize: function(data, options) {
        MVLeaflet.FlowLine.prototype.initialize.call(this, data, options);
    }
});

MVLeaflet.arcedFlowLine = function(data, options) {
    return new MVLeaflet.ArcedFlowLine(data, options);
};

MVLeaflet.ArcedPolyline = MVLeaflet.Path.extend({
    includes: TextFunctions,
    ...
    options: {
        distanceToHeight: new MVLeaflet.LinearFunction([ 0, 5 ], [ 1e3, 200 ]),
        color: "#FFFFFF",
        opacity: 1,
        weight: 1,
        fillColor: "#000000",
...
MVLeaflet.arcedPolyline = function(latlngs, options) {
    return new MVLeaflet.ArcedPolyline(latlngs, options);
};

MVLeaflet.Control.Legend = MVLeaflet.Control.extend({
    options: {
        position: "bottomright",
        autoAdd: true
    },
    onAdd: function(map) {
        var className = "leaflet-control-legend", container = MVLeaflet.DomUtil.create("div", className);
        var self = this;
        ...
        this.toggleSize = MVLeaflet.bind(this.toggleSize, this);
        MVLeaflet.DomEvent.addListener(container, "mouseover", this.toggleSize).addListener(container, "mouseout", this.toggleSize).addListener(container, "click", MVLeaflet.DomEvent.stopPropagation).addListener(container, "click", MVLeaflet.DomEvent.preventDefault);
        return container;
    },
    clear: function() {
    ...
    toggleSize: function() {
        if (MVLeaflet.DomUtil.hasClass(this._container, "larger")) {
            MVLeaflet.DomUtil.removeClass(this._container, "larger");
        } else {
            MVLeaflet.DomUtil.addClass(this._container, "larger");
        }
    },
    ...
    addLayer: function(layer) {
        var id = MVLeaflet.Util.stamp(layer);
        var me = this;
        if (layer.getLegend) {
    ...
    addLegend: function(id, html) {
        ...
        if (!legend) {
            legend = MVLeaflet.DomUtil.create("div", "", container);
            legend.id = id;
        }
...
MVLeaflet.control.legend = function(options) {
    return new MVLeaflet.Control.Legend(options);
};
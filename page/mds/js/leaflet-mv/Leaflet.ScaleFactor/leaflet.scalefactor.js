(function (factory, window) {
    ...
    var ScaleFactor = L.Control.extend({
        ...
        _pxTOmm: (function () {
            ...
            var pxPermm = heightRef.clientHeight;   // Modified to remove jQuery dependency
        ...
        _update: function () {
			...
			// var RealWorlMetersPer100Pixels = (
			// 	map.containerPointToLatLng([0, CenterOfMap]).distanceTo(
			// 	map.containerPointToLatLng([100, CenterOfMap]))
			// );
